						...
						try {
							...
							do {
								...
								case 1:
									...
									do {
										try {
											...
											flag = false;
											System.err.println("Book-Name should contain only Alphabets");
										} catch (LMSException e) {
											flag = false;
											System.err.println(e.getMessage());
										}
									...
									do {
										try {
											...
											flag = false;
											System.err.println("Author Name should contain only Alphabates");
										} catch (LMSException e) {
											flag = false;
											System.err.println(e.getMessage());
										}
									...
									do {
										try {
											...
											flag = false;
											System.err.println("Book-Category should contain only Alphabates");
										} catch (LMSException e) {
											flag = false;
											System.err.println(e.getMessage());
										}
									...
									do {
										try {
											...
											flag = false;
											System.err.println("Book-PublisherName should contain only Alphabates");
										} catch (LMSException e) {
											flag = false;
											System.err.println(e.getMessage());
										}
								...
								case 4:
									...
									break;
								case 5:
									System.out.println("Search the book by Book_Category :");
